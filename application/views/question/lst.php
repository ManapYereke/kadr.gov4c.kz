...
<script type="text/javascript">
	ONLOAD.push(function(){
		$('.table').dataTable( {
			...
			, "columns": [
					{ "data": "tb0302_id", "className": "text-center" }
					, { "data": "tb0302_tb0301_id", "className": "text-center" }
					, { "data": "tb0302_order", "className": "text-center" }
					, { "data": "tb0302_desc_ru", "className": "text-center" }
					, { "data": "tb0302_desc_kz", "className": "text-center" }
					, { "data": "tb0302_created", "className": "text-center" }
					, { "data": "tb0302_createdby", "className": "text-center" }
				]
			, "columnDefs": [
					{
